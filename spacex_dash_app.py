...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown', placeholder='Select a site', searchable=True,
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        filtered_df.replace([0, 1], ['Unsuccessful', 'Successful'], inplace=True)
        fig = px.pie(filtered_df, values='Flight Number',
                     names='class',
                     title='Successful and unsuccessful launches for the {} site '.format(entered_site))
    return fig
